...
def ofac_csn_transformed():
    ...
    output_csv = os.path.join(data_dir,'ofac_USOFAC_Consolidated_cleaned.csv')

    
    input_data_dir = os.path.abspath(os.path.join(os.path.dirname(__file__),"..","output"))

    input_csv = os.path.join(input_data_dir,'ofac_USOFAC_Consolidated_parsed.csv')
