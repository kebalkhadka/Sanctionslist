...
def clean_australia_data():
    # Define file paths
    script_dir = os.path.dirname(os.path.abspath(__file__))
    base_dir = os.path.dirname(script_dir)

    input_csv = os.path.join(base_dir, 'output', 'aus_Australia_parsed.csv')
    output_csv = os.path.join(base_dir, 'cleaned', 'aus_Australia_cleaned.csv')
