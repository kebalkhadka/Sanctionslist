...
def interpol_transformed():
    ...
    output_csv = os.path.join(data_dir,'interpol_red_cleaned.csv')

    
    input_data_dir = os.path.abspath(os.path.join(os.path.dirname(__file__),"..","output"))

    input_csv = os.path.join(input_data_dir,'interpol_red_notices.csv')
